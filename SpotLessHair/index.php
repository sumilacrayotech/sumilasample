...
<body>
	...
	</header><?php require('../dbconnect.php');?>
		
	<?php $sql = "SELECT  * FROM sliders";
//echo $sql;
	...
	<div id="homeSlider" class="carousel slide" data-ride="carousel">
		...
		<!--<div class="carousel-inner">
			<div class="carousel-item active">
				<div class="sliderImg" style="background-image: url(img/slider01.jpg)" ></div>
			...
			<div class="carousel-item">
				<div class="sliderImg" style="background-image: url(img/slider02.jpg)" ></div>
				<div class="carousel-caption d-flex align-items-center">
					<div>
		...
		<div class="carousel-inner">
			<div class="carousel-item active">
				<div class="sliderImg" style="background-image: url(<?php echo "../admin/images/$arr[0]";?>)" ></div>
				<div class="carousel-caption d-flex align-items-center">
					<div>
						<h1>Lice & Nits <br><span>Elimination Device</span></h1>
						<p>At spotless hair, we use the latest end most advanced patented European devices that are approved by Saudi Food and Drug Authority (SFDA).</p>
			...
			<?php if (count($arr)>=2){?>
			<div class="carousel-item">
				<div class="sliderImg" style="background-image: url(<?php echo "../admin/images/$arr[1]";?>)" ></div>
				<div class="carousel-caption d-flex align-items-center">
					<div>
						<h1>Lice & Nits <br><span>Removal Comb</span></h1>
						<p>In this stage, the hair is divided into several sections according to length and density, then the process of combing each section commence</p>
			...
			<?php if (count($arr)>=3){?>
			<div class="carousel-item">
				<div class="sliderImg" style="background-image: url(<?php echo "../admin/images/$arr[2]";?>)" ></div>
				<div class="carousel-caption d-flex align-items-center">
					<div>
						<h1>Lice & Nits <br><span>Removal Comb</span></h1>
						<p>In this stage, the hair is divided into several sections according to length and density, then the process of combing each section commence</p>
			...
			<?php if (count($arr)>=4){?>
			<div class="carousel-item">
				<div class="sliderImg" style="background-image: url(<?php echo "../admin/images/$arr[3]";?>)" ></div>
				<div class="carousel-caption d-flex align-items-center">
					<div>
						<h1>Lice & Nits <br><span>Removal Comb</span></h1>
						<p>In this stage, the hair is divided into several sections according to length and density, then the process of combing each section commence</p>
			...
			<?php if (count($arr)>=5){?>
			<div class="carousel-item">
				<div class="sliderImg" style="background-image: url(<?php echo "../admin/images/$arr[4]";?>)" ></div>
				<div class="carousel-caption d-flex align-items-center">
					<div>
						<h1>Lice & Nits <br><span>Removal Comb</span></h1>
						<p>In this stage, the hair is divided into several sections according to length and density, then the process of combing each section commence</p>
				...
				<div class="row">
					<div class="col-md-5">
						<div class="homeAboutImg">
							...
							<img src="img/h-about1.jpg">							
						</div>
					</div>
					<div class="col-md-7 d-flex align-items-center pl-50">
						<div>
							<h5>About Us</h5>
							<?php $sql = "SELECT  * FROM aboutus";
//echo $sql;
$result = $conn->query($sql);
...
if ($result->num_rows > 0) {
	...
	<div class="packegeBlock">
		<div class="packegeItem" style="background-image: url(img/package-img1.jpg)">
		...
		<div class="packegeItem" style="background-image: url(img/package-img2.jpg)">
			<div class="packegeContent">
